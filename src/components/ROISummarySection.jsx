...
const ROISummarySection = ({ results, inputs, currency, currencySymbol, trirUnit, getRoiRating, formatCurrency, formatCurrencyNoCents, formatNumber, calculateSensitivityRoi, sensitivityScenarios, setCurrentStep, generatePDF, userEmail }) => (
    <>
        {userEmail && (
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-green-700">
                            <p>Your ROI business case summary has been sent to <strong>{userEmail}</strong></p>
                            <p className="mt-1">Check your inbox for the detailed PDF report. We've also copied our team so they can follow up with you soon.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <SectionCard title="Benefits Breakdown (Over Calculation Period)" color="green" className="mb-6">
            <table className="min-w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-200">
                    ...
                    <tr><td className="py-2 pr-2">Productivity Gain ({inputs.productivityGainPercent}%)</td><td className="py-2 text-right font-medium">{formatCurrency(results.productivityGain, currency, currencySymbol)}</td><td className="py-2 pl-2 text-xs text-gray-500">{inputs.productivityGainPercent}% of total labor cost</td></tr>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
            <button onClick={() => setCurrentStep(5)} className="text-gray-600 hover:text-orange-500 font-medium py-2 px-4 rounded-lg w-full sm:w-auto">Back to Email</button>
